...
import { LayoutDashboard, TableProperties, Shield, Activity, LineChart, Radar, Building2, Newspaper, Wallet, Eye, Crosshair, HeartPulse, TrendingUp } from 'lucide-react';
