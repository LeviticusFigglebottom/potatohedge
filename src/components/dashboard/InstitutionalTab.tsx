...
import {
  Building2, RefreshCw, Loader2, ArrowRightLeft, ShieldAlert, AlertTriangle,
} from 'lucide-react';
      ...
      {data && (
        <>
            ...
            <div className="px-4 py-3">
              {data.swapSummary.available ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-xs text-text-muted/60 mt-1">Data publishes after market hours — check back later, or the DTCC endpoint may be temporarily unreachable.</p>
                </div>
              )}
            </div>
          </div>
            ...
            <div className="px-4 py-3">
              {data.regSHOList.length > 0 ? (
                ...
                <div className="text-center py-6">
                  ...
                  <p className="text-xs text-text-muted/60 mt-1">FINRA data may not be accessible or the list may be empty today.</p>
                </div>
              )}
            </div>
          </div>
            ...
            <div className="px-4 py-3">
              {data.shortInterestHighlights.length > 0 ? (
                ...
                <div className="text-center py-6">
                  ...
                  <p className="text-xs text-text-muted/60 mt-1">FINRA short interest data updates bi-monthly.</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="text-center text-[10px] text-text-muted/40 font-mono py-2">
            DTCC Public Price Dissemination (pddata.dtcc.com) &bull; FINRA Short Interest &amp; Reg SHO (api.finra.org)
          </div>
        </>
      )}
    </div>
