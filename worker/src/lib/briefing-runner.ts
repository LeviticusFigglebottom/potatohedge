...
7. **Expiration selection**: ALL trade ideas — including any "event play", "gamma flip straddle", "expiration pin", or similar tactical setup — MUST have every leg at a minimum of 5 DTE. The automation refuses to open anything shorter. Credit strategies (iron condors, credit spreads) should use 30-45 DTE for meaningful premium — NEVER use near-expiry strikes for premium-selling strategies. Debit strategies should use 14-21 DTE. 0-4 DTE plays are FORBIDDEN; do not propose them under any circumstance. State the concrete DTE clearly in your expiration field.
